...
public final class Constants {
    ...
    public static final double SHOOTER_PERCENT_OUTPUT_GREEN = 0.5;
    public static final double SHOOTER_PERCENT_OUTPUT_YELLOW = 0.55;
    public static final double SHOOTER_PERCENT_OUTPUT_BLUE = 0.6;
    public static final double SHOOTER_PERCENT_OUTPUT_RED = 0.65;
    public static final double SHOOTER_PERCENT_OUTPUT_REINTRODUCTION = 0.7;
    ...
    */
    ...
    //      Autonomous     //
    //=================-==//
    public static final double AUTO_SPEED_FORWARD = 0.5;
